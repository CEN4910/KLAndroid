package com.lb.UCFKnightsLive.data.model;

import android.content.ContentValues;
import android.os.Parcel;
import android.os.Parcelable;
import com.lb.UCFKnightsLive.data.database.ItemsTable;
...
public class DataItem implements Parcelable {
    ...
    public DataItem(String itemId, String itemName, String category, String description, int sortPosition, String image) {
